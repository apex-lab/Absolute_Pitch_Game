...
export default class Level11Scene extends Phaser.Scene {
    ...
    startLevel() {
        ...
        this.enemyTypes = ['MagentaFriendly', 'PinkFriendly','LightBlueEnemy', 'OrangeEnemy'];
            this.levelQueues = {
                level11: generateBalancedQueue(this.enemyTypes, 28, 7),
            };
            this.currentQueue = [...this.levelQueues.level11];
    ...
    async checkForNextLevel() {
        await handleLevelCompletion(this, 'Level12Scene', 11); 
    }
}