...
export default class Level12Scene extends Phaser.Scene {
    ...
    startLevel() {
        ...
        this.enemyTypes = ['MagentaFriendly', 'PinkFriendly','LightBlueEnemy', 'OrangeEnemy','BlueEnemy','AquaFriendly'];
            this.levelQueues = {
                level12: generateBalancedQueue(this.enemyTypes, 42, 7),
            };
    ...
    async checkForNextLevel() {
        await handleLevelCompletion(this, 'Level13Scene', 12); 
    }
}