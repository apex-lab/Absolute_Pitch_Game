...
export default class Level13Scene extends Phaser.Scene {
    ...
    startLevel() {
        ...
        this.enemyTypes = ['MagentaFriendly', 'PinkFriendly','LightBlueEnemy', 'OrangeEnemy','BlueEnemy','AquaFriendly', 'YellowEnemy', 'LightPurpleFriendly'];
            this.levelQueues = {
                Level13Scene: generateBalancedQueue(this.enemyTypes, 56, 7),
            };
