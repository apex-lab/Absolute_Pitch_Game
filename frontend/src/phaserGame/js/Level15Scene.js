...
export default class Level15Scene extends Phaser.Scene {
    ...
    startLevel() {
        ...
        this.enemyTypes = ['MagentaFriendly', 'PinkFriendly','LightBlueEnemy', 'OrangeEnemy','BlueEnemy','AquaFriendly', 'YellowEnemy', 'LightPurpleFriendly', 'GreenEnemy', 'BrownFriendly', 'PurpleEnemy', 'RedFriendly'];
        
            this.levelQueues = {
                Level15Scene: generateBalancedQueue(this.enemyTypes, 840, 7),
            };
    ...
    async checkForNextLevel() {
        await handleLevelCompletion(this, 'TitleScene', 15); 
    }
}